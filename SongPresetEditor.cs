...
namespace SynthLiveMidiController
{
    ...
    {
        KeyboardPicture kbdPicture = new KeyboardPicture();
    ...
    public class KeyboardPicture
    {
        ...
        private Pen kbdPen = new Pen(Color.Black);
        private Brush kbdWhiteBrush = Brushes.White;
        private Brush kbdBlackBrush = Brushes.DarkSlateGray;
